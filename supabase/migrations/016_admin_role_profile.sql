-- =============================================================================
-- Migration 016 — Rôle admin reconnu dans le profil Programme
-- =============================================================================
...
BEGIN
  ...
  v_is_admin := public.has_role(p_user_id, 'admin') OR v_profile.role = 'admin';
  ...
  RETURN json_build_object(
    ...
    'role', CASE
      ...
      WHEN v_is_ambassador THEN 'ambassador'
      ELSE v_profile.role
    END,
    'name', COALESCE(
