-- =============================================================================
-- Migration 012 — Profil Programme en 1 requête (perf connexion Academy)
-- =============================================================================
...
GRANT EXECUTE ON FUNCTION public.get_ambassador_program_profile(UUID) TO authenticated;

COMMENT ON FUNCTION public.get_ambassador_program_profile IS
  'Profil Programme unifié (profiles + links + tier + rôle) — 1 round-trip pour Academy.';
